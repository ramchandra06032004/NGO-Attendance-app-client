  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.backgroundColors ? colors.backgroundColors[0] : '#fff' }]}>
      <ScrollView contentContainerStyle={styles.card}>
        <Text style={[styles.title, { color: colors.header }]}>Add College</Text>
        ...
        <TouchableOpacity style={[styles.submit, { backgroundColor: colors.accent }]} onPress={onSubmit}><Text style={{ color: '#fff' }}>Add College</Text></TouchableOpacity>
